...
inputFile = LOAD 'hdfs:///user/Anisha/inputs' USING PigStorage('\t') AS (name:chararray, line:chararray);
...
-- rmf hdfs:///user/Anisha/PigProjectOutput;

-- Store the results into folder
STORE result INTO 'hdfs:///user/Anisha/PigProjectOut';
